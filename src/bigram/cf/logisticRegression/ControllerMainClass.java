...
public class ControllerMainClass {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(beans.getUrlArr().length());
		System.out.println(beans.getBigramArr().length());
	...
	NameBeans dataInitial(){
		...
		beans.setRawDomain(filePath+	"mergeToRaw/merge-1tNormal-2hDga.txt"); //資料來源，例：a17l68o41k27nqpwe21o61p22c59i45muo51f32iwas.info,n
